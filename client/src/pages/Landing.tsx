    ...
    <div className="min-h-screen bg-background" data-testid="page-landing">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Button onClick={onOpenApp} data-testid="button-open-app-nav">
              Open app
            </Button>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-background border-t px-4 py-4 space-y-3">
            ...
            <Button onClick={onOpenApp} className="w-full" data-testid="button-open-app-mobile">
              Open app
            </Button>
          </div>
        )}
      ...
      <section id="how-it-works" className="py-16 px-4 bg-secondary/20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-10">
            <Button onClick={onOpenApp} data-testid="button-open-app-how">
              Open app
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Card className="p-6 border-2 border-primary">
              ...
              <Button className="w-full" onClick={onOpenApp}>
                Get started free
              </Button>
            </Card>
      ...
      <section className="py-16 px-4 bg-primary/10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Button size="lg" onClick={onOpenApp} data-testid="button-open-app-cta">
            Open Swift Shaadi
            <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
        </div>
